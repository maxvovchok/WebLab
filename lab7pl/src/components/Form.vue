<template>
  <form class="modal-form" @submit.prevent>
    ...
    <label class="form-description">
      <span class="form-description-text-name">Ім'я</span>
    ...
    <label class="form-description">
      <span class="form-description-text-name">Прізвище</span>
      <div class="form-input-wrapper">
        <input
          v-model="lastName"
          class="form-input"
    ...
    <label class="form-description">
      <span class="form-description-text-name">По батькові</span>
      <div class="form-input-wrapper">
        <input
          v-model="middleName"
          class="form-input"
    ...
    <label class="form-description">
      <span class="form-description-text">Електронна пошта</span>
      <div class="form-input-wrapper">
    ...
    <label class="form-description">
      <span class="form-description-text">Телефон</span>
      <div class="form-input-wrapper">
        <input
          v-model="phone"
          v-mask="'+38(###) ###-##-##'"
    ...
    <label class="form-description">
      <span class="form-description-text">Пароль</span>
      <div class="form-input-wrapper">
    ...
    <label class="form-description">
      <span class="form-description-text">Дата народження</span>
      <div class="form-input-wrapper">
    ...
    <label class="form-description">
      <span class="form-description-text">Група</span>
      <div class="form-input-wrapper">
    ...
    <label class="form-description">
      <span class="form-description-text">Завантажити документ</span>
      <div class="form-input-wrapper">
        <input
          ref="documentInput"
          class="form-input"
    ...
    <label class="form-description">
      <span class="form-description-text">Стать</span>
      <div class="form-input-wrapper">
        <label>
          <input type="radio" v-model="gender" value="Male" required /> Чоловіча
        </label>
        <label>
          <input type="radio" v-model="gender" value="Female" /> Жіноча
        </label>
      </div>
    ...
    <button type="submit" @click="submitForm" class="form-btn-send">
      Надіслати
    </button>
  </form>
</template>
